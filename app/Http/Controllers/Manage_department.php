...
class Manage_department extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.class.manage_department',['class_list'=>manage_class_model::all(),'department'=>manage_department_model::all(),'medium'=>$medium]);
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            {   
                $manage_department->fill($request->all())->save();
    ...
    {
        $medium=ov_setup_model::where('type','Medium')->get();
        return view('admin.class.Edit.manage_department_edit',['department_info'=>manage_department_model::where('id',$id)->first(),'class_list'=>manage_class_model::all(),'medium'=>$medium]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            $manage_department::where('id',$id)->first()->fill($request->all())->save();
