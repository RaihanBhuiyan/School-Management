...
class manage_subject extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.subject.manage_subject',['teacher'=>teacher_model::all(),'request_class'=>$id,'subject_list'=>manage_subject_model::where('class',$id)->get(),'component_data'=>component_model::all(),'medium'=>$medium]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.subject.Edit.manage_subject_edit',['all_component'=>component_model::all(),'particular_component_data'=>$component_data,'subject_info'=>manage_subject_model::where('id',$id)->first(),'request_class'=>$id,'class_list'=>manage_class_model::all(),'teacher_list'=>teacher_model::all(),'medium'=>$medium]);
    }
