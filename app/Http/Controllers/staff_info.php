...
class Staff_info extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.Teacher_Staff.staff_info',['medium'=>$medium,'job_type_data'=>$job_type_data,'work_department_data'=>$work_department_data]);
    }
