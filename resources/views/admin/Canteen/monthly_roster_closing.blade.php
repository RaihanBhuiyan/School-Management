...
@endif
    <div class="container">
         ...
         <p title="Transport Details">{{ Session::get('school.system_name') }}  Monthly Roster Closing</p> <!-- Transport Details -->
    ...
    margin-left: 301px" class="">
           ...
           <thead >
            <tr >
                <th style="background: #1F262D;height: 34px;width: 181px;color: #fff;border: 1px solid white;">Month</th>
           ...
           $(document).ready(function(){
             ...
             $(".gif_show").click(function(){
               ...
               $.ajax({
                   ...
                   type:'post',
                    data:{'month':month,'year':year,'_token': $('input[name=_token]').val()},
          ...
          $('.report_data_table').on('click', '#create_invoice', function(eq) {
             ...
             //alert(student_roll+student_name+student_class+department+total);
              $.ajax({
                   ...
                   type:'post',
                   data:{'month':month,'year':year,'student_roll':student_roll,'student_name':student_name,'student_class':student_class,'department':department,'total':total,'_token': $('input[name=_token]').val()},
                   success:function(r){
                      alert(r);
