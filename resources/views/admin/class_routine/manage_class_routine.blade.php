...
<span style="margin-top: 3%;" class="text-center tag">Medium : {{$medium_grp_data->medium}}</span>     
      ...
      <div class="widget-box">
        ...
        {{Form::open(['url'=>'/manage_class_routine','files'=>true,'class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
            ...
            <div class="control-group">
              ...
              <div class="controls">
          @php
            $department_data=DB::table('manage_department')->where('class_name',$class_name)->get();
...
@foreach($department as $department_value)
<p style="margin-top: 3%;" class="text-center tag">{{$department_value->department}}</p>
<br>
        @foreach($section as $section_value)
