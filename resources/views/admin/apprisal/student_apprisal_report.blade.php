		...
		<div class='row'>
			<div class="panel panel-default" >
				<div class="panel-body text-left">
					<ul class='dropdown_test'>
						<li><a href='/student_apprisal'><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Apprisal</a></li>
						<li><a href='/student_apprisal_component'><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Apprisal Template</a></li>

						<li><a href='/apprisal_template_report'><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;Apprisal Template Report</a></li>
			...
			<div class="controls text-right">
				<div data-toggle="buttons-checkbox" class="btn-group">
					<button  class="btn btn-default" title='Export PDF' type="button"><a target="_blank" href="/student_apprisal_pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
					</button>

					<button class="btn btn-default" title='Export Excel' type="button"><a  href="/student_apprisal_excel"><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
					</button>

					<button class="btn btn-default" title='Preview' ttype="button"><a target="_blank" href="/student_apprisal_pdf"><i class="fa fa-street-view" aria-hidden="true"></i></a>
					</button>

					<button id='print' class="btn btn-default" title='Print' type="button"><i class="fa fa-print" aria-hidden="true"></i>
					</button>
				</div>
			</div>
		</div>
							...
							@foreach($apprisals as $apprisal)
								<tr class="gradeX">
									...
									<td>
										...
										@endphp
										{{isset($apprisal_person_name->title) ? $apprisal_person_name->title : ''}}</td>
