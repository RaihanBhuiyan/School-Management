    ...
    margin-left: 5%" class="">
           ...
           <thead >
            <tr >
                ...
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Student Roll</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Class</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">From Date</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">To Date</th>
            ...
            <tbody>
            <tr>
              <td>{{Form::text('student_roll','',['style'=>'width: 170px','id'=>'student_roll','class'=>'student_roll'])}}</td>
                <td>
                  @php
                ...
                <td>{{Form::date('from_date','',['data-date-format'=>'mm-dd-yyyy','style'=>'width:170px','id'=>'from_date'])}}</td>
                <td>{{Form::date('to_date','',['data-date-format'=>'mm-dd-yyyy','style'=>'width:170px','id'=>'to_date'])}}</td>
                 <td>{{Form::submit('Generate Report',['style'=>'width: 188px;
    margin-bottom: 2px;','class'=>'btn btn-success gif_show','id'=>'report_show_btn','disabled'])}}</td>
     ...
     <script type="text/javascript">
           ...
           $(document).ready(function(){
            $('#student_roll').keyup(function(){
              ...
              // alert(class_name);
              if(class_name.length==0 && roll.length==0 &&from_date.length==0 &&to_date.length==0)
              {
