    ...
    <div class="container">
        ...
        <thead style="background: #1F262D">
            ...
            <td>
             ...
             <td>
                {{Form::button('Generate Report',['class'=>'btn btn-success','id'=>'student_marks_report','style'=>'width: 152px;
    margin-top: -8px;'])}}
            </td>
          </tr>
            </tbody>
           ...
           $("#student_marks_report").click(function(){
                 ...
                 else
                 {
                    ...
                    $.ajax({
                        url:'/marks_report',
                        type:"POST",
                        data:{'exam_name':exam_name,'class_name':class_name,'section':section,'department_name':department_name,'session':session,'_token':"{{csrf_token()}}"},
