        ...
        <table style="margin-top: 4%; margin-left: 3%" class="">
            ...
            <tr>
                ...
                <td>
                 ...
                 <td>{{Form::select('type',[''=>'--select--','Staff'=>'Staff','Teacher'=>'Teacher','Student'=>'Student'],null,['style'=>'width: 85px','id'=>'department','class'=>'department'])}}</td>
              
                <td>{{Form::text('all','',['style'=>'width: 85px','id'=>'all','class'=>'all'])}}</td>
               <td>
                 {{Form::submit('Generate Report',['style'=>'width: 125px;margin-top: -11px;
        ...
        $(document).ready(function(){
        	...
        	$(".report_view").unbind().click(function(){
        		    ...
        		    $.ajax({
        		    	...
        		    	type:'POST',
        		    	data: {'party':party,'ledger_head':ledger_head,'department':department,'all':all,'_token': $('input[name=_token]').val()},
