    ...
    <div class="container">
      ...
      <div class="tab-content"> <!-- Transport List Report  -->
        ...
        <div id="home" class="tab-pane fade in active">
         <div id="report_container" style="display: block;"><div class="scroll-report">
              @permission('PRINT')
        <button style="    margin-left: 1070px;">
          <a id='print' onclick="pop_print()" media='print' target="_blank"  title='Print' type="button"><i class="fa fa-print" aria-hidden="true"></i></a>
        </button>
        <button >
            ...
            <div align="center">
             ...
             <div style="margin-right: 188px;" width="100%" class="">
              <table border="0" cellspacing="0" style="margin-top: 40px;"> 
                <tbody>
                  <tr>
                    <td align="center"><b><font size="3">{{Session::get('school.system_name')}}( {{Session::get('school.school_eiin')}} )</font></b>
                    </td>
                   </tr>
                   <tr>
                    <td align="center"><b><font size="2">{{Session::get('school.address')}}( {{Session::get('school.postal_code')}} ) {{Session::get('school.country')}}</font></b>
                    </td>
                   </tr>   
                   <tr>
                    <td align="center"><b><font size="2">Phone:- {{Session::get('school.Phone')}} </font></b>
                  </td>
                  </tr>
                </tbody>
               </table>
         ...
         <table width="85%" border="0" cellspacing="0"> 
            <tbody>
              ...
              <tr>
                ...
                <td class="align-left">
                    <div align="left" style="margin-left: 14px;"><strong>: </strong>{{date("F")}}</div>
                </td>
             </tr>  
             <tr>
                <th>
                ...
                <td class="align-left">
                    <div align="left" style="margin-left: 14px;"><strong>: </strong>{{date("Y")}}</div>
                </td>
             </tr>
             <tr>
               <th width="20%">
               ...
               <td class="align-left">
                ...
                <td class="align-left">
                    <div align="left" style="margin-left: 14px;"><strong>: </strong>{{date("d")}}</div>
                </td>   
         ...
         <div style="text-align:center;display:none;" class="gif">
          <img src="{{asset('img/loading2.gif')}}" style="height: 150px;margin-top: 20px;"/>
                ...
                <table border="1" style="width: 1000px;">
                 ...
                 <tr>
                  <td>
                 <table border="1" cellpadding="11" cellspacing="3" style="width: 561px;height: 165px;">
                  <tr>
                 ...
                 @foreach($asset_revenue_data as $key=>$fetch_data)
                    ...
                    <td style="width: 50px;">{{$fetch_data->account_name}}</td>
                      @php
                   $income_account_name=DB::table('chart_of_accounts')->where('account_code',$fetch_data->account_name)->first();
                    @endphp
                     <td style="width: 703px;">{{$income_account_name->account_name}}</td>
                     @if($previous_date==$fetch_data->created_at->year)
                     
                      <td style="width: 100px;">{{$fetch_data->dr_amount-$fetch_data->cr_amount}}</td>
                           @php
            ...
            <td>
              <table border="1" cellpadding="11" cellspacing="3" style="width: 601px;height: 165px;">
               <tr>
                     <th style="width: 50px;">Sl No</th>
                     <th style="width: 50px;">Account code</th>
                     <th style="width: 703px;">Account Name</th>
                ...
                @foreach($asset_revenue_data as $key=>$fetch_data)
                 ...
                 <tr>
                   @if($fetch_data->account_name==$fetch_data->account_code && $fetch_data->parent_account=='Asset')
                      ...
                      <td style="width: 50px;">{{$key+1}}</td>
                       <td style="width: 50px;">{{$fetch_data->account_name}}</td>
                    @php
                     $asset_account_name=DB::table('chart_of_accounts')->where('account_code',$fetch_data->account_name)->first();
                    @endphp
                       <td style="width: 703px">{{$asset_account_name->account_name}}</td>
                     @if($previous_date==$fetch_data->created_at->year)
                      ...
                      <table border="1" style="width: 1000px;">
                        <tr>
                          <td >
                            <table border="1" cellpadding="11" cellspacing="3" style="width: 562px;height: 40px;">
                      <tr>
                 ...
                 <td>
                    <table border="1" cellpadding="11" cellspacing="3" style="width:600px;height: 40px;">
                       <tr>
                ...
                <table border="1" >
                  <tr>
                 <td >
                     <table border="1" cellpadding="11" cellspacing="3" style="width: 1166px;height: 40px;"> 
                      <tr>
