...
@section('content')
    ...
    <div class="container">
         ...
         <p title="Transport Details">{{ Session::get('school.system_name') }}  Book List Report</p> <!-- Transport Details -->
       ...
       margin-left: 24px;" class="">
           ...
           <thead >
            <tr >
                ...
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Book Name</th>
        ...
        <table style="margin-top: 60px;border: 0px solid gray;width: 95%;">
          ...
          <tr>
              <td rowspan="2">
                ...
                <br>
                 <h4 style="margin-left: 495px;margin-top: -20px;">School EIIN: {{Session::get('school.school_eiin')}}</h4>
                 <br>
