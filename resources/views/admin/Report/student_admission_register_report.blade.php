...
@section('content')
    ...
    <div class="container">
          <!-- Tab Heading  -->
         <h2 style="font-size: 36px;margin-left: 239px;margin-top: 48px;" title="Transport Details">{{ Session::get('school.system_name') }}</h2>
           <p style="font-size: 26px;margin-left: 414px;margin-bottom: 24px;margin-top: 23px;">{{ Session::get('school.address') }}</p>
            <p style="font-size: 28px;margin-left: 365px;margin-bottom: 56px;">Student Admission Register Report</p> <!-- Transport Details -->
...
{{Form::open(['url'=>'/student_admission_register_report','class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
    ...
    margin-left: -9%;">
            ...
            <tbody>
            <tr>
               <td>{{Form::text('applicant_id','',['style'=>'width: 100px','id'=>'applicant_id','class'=>'applicant_id'])}}</td>
              <td>{{Form::text('student_name','',['style'=>'width: 100px','id'=>'student_name','class'=>'student_name'])}}</td>
                <td>
