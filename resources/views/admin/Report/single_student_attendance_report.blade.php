...
@section('content')
    ...
    <div class="container">
          <h2><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Single Student Attendance Report</h2> <!-- Tab Heading  -->
         <p title="Transport Details">{{ Session::get('school.system_name') }}  Single Student Attendance Report</p> <!-- Transport Details -->
