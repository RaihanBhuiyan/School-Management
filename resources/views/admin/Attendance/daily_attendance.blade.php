                       ...
                       <td> 
                        {{Form::date('date',\Carbon\Carbon::now(),['id'=>'datepicker','title'=>'date','style'=>'width: 126px'])}}
                         ...
                         @php
                          ...
                          @endphp
                          @endforeach
                        <td>{{Form::select('Session',$session_array,null,['style'=>'width: 112px','class'=>'default_session','id'=>'default_session'])}}</td>
                        ...
                        <td>{{Form::select('section',['Section Name'=>'Section Name'],null,['id'=>'section_info','style'=>'width: 157px'])}}</td>
                         ...
                         <td>{{Form::select('Department',['Department Name'=>'Department Name'],null,['id'=>'Department_info','style'=>'width: 84px'])}}</td>
...
<div class="container">
  ...
  <center>
    <a class="btn btn-default present" ><i class="fa fa-check-square-o" aria-hidden="true"></i> Mark All Present</a>
