...
<!--
    ...
    <table style="margin-top: 4%; margin-left: 3%" class="">
        <thead style="background: #1F262D">
            ...
            <td>{{Form::select('Default Session',[$general->default_session=>$general->default_session],null,['style'=>'width: 157px','readonly'=>'readonly','class'=>'default_session','id'=>'default_session'])}}</td>
