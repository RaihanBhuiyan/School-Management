    ...
    <div class='row'>
        ...
        <div class="controls text-right">
            <div data-toggle="buttons-checkbox" class="btn-group">
                ...
                <a id='print' class="btn btn-success" onclick="UpdateSort()" title='Print' type="button">Update Sort</a>
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered">
                        ...
                        @foreach($teacher_report as $teacher_reports)
                            <tr class="gradeX sort_teacher_each" data_teacher_id="{{$teacher_reports->teacher_id}}">
                                ...
                                <td>{{$teacher_reports->medium}}</td>
                                <td style="width: 8%;"><img onerror="this.src='img/blankavatar.png'" src='{{URL::asset("img/backend/teacher_staff/$teacher_reports->teacher_id")}}.jpg'></td>

                                <td class="center">

                                    <div class="display_status">
                                        @permission('EDIT') {{Form::open(['url'=>"teacher_info/$teacher_reports->teacher_id/edit" ,'method'=>'GET'])}} {{Form::submit('Edit',['class'=>'btn btn-primary'])}} {{Form::close()}} @endpermission @permission('DELETE') {{Form::open(['url'=>"teacher_info/$teacher_reports->teacher_id" ,'method'=>'DELETE'])}} {{Form::submit('Delete',['class'=>'btn btn-danger','onclick'=>"return confirm('Are you sure you want to Remove ?')"])}} {{Form::close()}} @endpermission
                                    </div>
                                </td>
                            </tr>
                        @endforeach
