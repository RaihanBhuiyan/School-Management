...
@endif
	...
	<div class="container">
 		...
 		<p title="Transport Details">{{Session::get('school.system_name')}}  Teacher Details Edit</p> <!-- Transport Details -->
     ...
     <div class='row'>
         ...
         <div class="panel panel-default" >
          <div class="panel-body text-left">
            ...
            <li><a href='/teacher_info_report'><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
             </ul>
          </div>
        </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <table class="table address">
                      ...
                      <tbody>
                       <tr>
                          <td>{{Form::text('post_office',$teacher_address_child->post_office,['id'=>'a_table','title'=>'post_office','placeholder'=>'Post Office'])}} </td>
                          <td>{{Form::text('home_district',$teacher_address_child->home_district,['id'=>'a_table','title'=>'home_district','placeholder'=>'Home District'])}}</td>
                           <td>{{Form::text('division',$teacher_address_child->division,['id'=>'a_table','title'=>'division','placeholder'=>'Division'])}} </td>
                            <td>{{Form::text('village_name',$teacher_address_child->village_name,['id'=>'a_table','title'=>'village_name','placeholder'=>'Village Name'])}} </td>
                             <td>{{Form::text('home_name',$teacher_address_child->home_name,['id'=>'a_table','title'=>'home_name','placeholder'=>'Home Name'])}} </td>
                        </tr>
                      </tbody>
                    </table>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                  <table class="table address">
                                    ...
                                    <tbody>
                                     <tr>
                                        <td>{{Form::text('degree_name',$teacher_qualification_child->degree_name,['id'=>'a_table','title'=>'degree_name','placeholder'=>'Degree Name'])}} </td>
                                        <td>{{Form::text('board_name',$teacher_qualification_child->board_name,['id'=>'a_table','title'=>'board_name'])}} </td>
                                         <td>{{Form::text('passing_year',$teacher_qualification_child->passing_year,['id'=>'a_table','title'=>'passing_year'])}} </td>
                                          <td>{{Form::text('department_name',$teacher_qualification_child->department_name 	,['id'=>'a_table','title'=>'department_name'])}} </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
<!-- Password Is Not Mandatory
 -->
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    {{Form::image("img/backend/teacher_staff/$teacher->teacher_id.jpg",'Profile_image',['alt'=>'Your Image','class'=>'img-responsive img-circle blank_applicant_student_image','id'=>'blah','style'=>'width:19%'])}}
