                ...
                <table class="table table-bordered data-table">
                    ...
                    <tbody>
                      ...
                      <tr class="gradeX">
                        ...
                        <td>{{$staff_informations->job_type}}</td>
                        <td>{{$staff_informations->work_department}}</td>
                        <td>{{$staff_informations->medium}}</td>
                        <td>{{$staff_informations->mobile_no}} </td>
                        <td style="width: 8%;"><img onerror="this.src='img/blankavatar.png'" src='{{URL::asset("img/backend/teacher_staff/$staff_informations->teacher_id")}}.jpg'></td>
                        <td class="center">
