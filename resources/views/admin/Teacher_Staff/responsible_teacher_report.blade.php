...
@section('content')
    ...
    <div class="container">
          <h2><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Respnsible Teacher Advance Report</h2> <!-- Tab Heading  -->
         <p title="Transport Details">{{ Session::get('school.system_name') }}  Respnsible Teacher Advance Report</p> <!-- Transport Details -->
