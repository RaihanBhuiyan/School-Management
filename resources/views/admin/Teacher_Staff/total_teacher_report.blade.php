...
@section('content')
    ...
    <div class="container">
         ...
         <p title="Transport Details">{{ Session::get('school.system_name') }}  Total Teacher Advance Report</p> <!-- Transport Details -->
    ...
    margin-left: 10px" class="">
           ...
           <thead >
            <tr >
                ...
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Job Type</th>
