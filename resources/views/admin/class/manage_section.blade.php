...
<div class="container">
  ...
  <p title="Transport Details">{{Session::get('school.system_name')}}( {{Session::get('school.school_eiin')}}  Sections Details</p><br/> <!-- Transport Details -->
  ...
  <div class="controls text-right">
      ...
      <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-bars" aria-hidden="true"></i> Sections List</a></li>
        @permission('INSERT')
        <li><a data-toggle="tab" href="#menu1"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Sections</a></li>
        @endpermission
      </ul>
