...
{{--                       <td>{{$department_list->class_name}}</td>--}}
                      ...
                      @endpermission
                        ...
                        @permission('DELETE')
                         {{Form::button('Delete',['class'=>'btn btn-danger class_delete','value'=>$department_list->id])}}
                        @endpermission
      ...
      <div id="menu1" class="tab-pane fade">
        <div>
          ...
          <div class="widget-content nopadding">
           {{Form::open(['url'=>'/manage_department','class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
