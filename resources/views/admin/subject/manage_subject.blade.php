...
<div class='row'>
     <div class="panel panel-default" >
      <div class="panel-body text-left">
         <ul class='dropdown_test'> 
            ...
            <li><a href='/teacher_info_report'><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Teacher Report</a></li>
  ...
  <ul class="nav nav-tabs">
    ...
    @permission('INSERT')
    <li>
      <a data-toggle="tab" href="#menu1"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Subject Class</a>
    </li>
   @endpermission
  </ul>
          ...
          <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>{{$subject_list_data->department}}</td>
          ...
          {{Form::open(['url'=>'/manage_subject','class'=>'form-horizontal','method'=>'post','name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
             ...
             <div class="control-group" hidden="hidden">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  @php
                    $department=DB::table('manage_department')->where('class_name',$request_class)->get();
                ...
                <div class="controls">
                  @php
                    $section=DB::table('manage_section')->where('class',$request_class)->get();
                   ...
                   <div class="controls">
                    ...
                    <table class='table' style="width:80%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              <td>{{$component_data_list->component_name}} ( {{$component_data_list->abbr}} )</td>
                              <td>
