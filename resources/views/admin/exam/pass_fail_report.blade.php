...
@endif
    <div class="container">
         ...
         <p title="Transport Details">{{ Session::get('school.system_name') }} Pass Fail Report</p> <!-- Transport Details -->
       ...
       margin-left: 24px;" class="">
           ...
           <thead >
            <tr >
                ...
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Exam Name</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Class Name</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Section Name</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Department Name</th>
                <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Default Session</th>
             
                  <th style="background: #1F262D;height: 34px;     width: 181px;color: #fff;border: 1px solid white;">Search</th>
            </tr>
            </thead>
        ...
        <table style="margin-top: 60px;border: 0px solid gray;width: 95%;">
          ...
          <tr>
              <td rowspan="2">
                ...
                <br>
                 <h4 style="margin-left: 495px;margin-top: -20px;">School EIIN: {{Session::get('school.postal_code')}}</h4>
                 <br>
                <h4 style="margin-left: 363px;margin-top: -30px;">{{Session::get('school.address')}}, Postal Code-{{Session::get('school.postal_code')}}</h4>
              </td>
          </tr>
        </table>
      </div>
      ...
      <hr style="width: 95%;margin-top: -18px;border: 2px solid black;margin-left: 20px;">
                   ...
                   <div class="report_data_table">
                    @if($publish_status !='')
                      ...
                      <img style="margin-left: 445px;height: 73px;" src="{{URL::asset('/img/cross_unpublish_img.jpg')}}">
