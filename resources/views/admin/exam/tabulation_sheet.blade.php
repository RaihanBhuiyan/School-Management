      ...
      {{Form::open(['url'=>'/tabulation'])}}
        ...
        <tbody>
          <tr>
            ...
            <td>
              <input type="button" value="View Tabulation Sheet" class="btn btn-success tabulation_sheet">
            </td>
          </tr>
        </tbody>
        </table>
...
<form action="" method="post" accept-charset="utf-8">
  ...
  <center>
  @permission('PRINT')
 <a id='print' onclick="pop_print()" media='print'  title='Print' type="button"><i class="fa fa-print" aria-hidden="true" style="font-size: 45px;"></i></a>
