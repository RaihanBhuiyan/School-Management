  ...
  <p title="Transport Details">I SchoolExam List Details</p> <!-- Transport Details -->
   <div class='row'>
      ...
      <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-bars" aria-hidden="true"></i> Exam List</a></li>
        @permission('INSERT')
              ...
              <table class="table table-bordered data-table">
                  ...
                  @foreach($exam_list as $exam_list_data)
                    <tr class="gradeX">
                      ...
                      <td>@if($exam_list_data->publish =="Yes")
                      <i style="color: green" class="fa fa-circle" aria-hidden="true"></i> Publish
