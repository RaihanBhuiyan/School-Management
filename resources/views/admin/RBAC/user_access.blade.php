...
<div class="container">
  ...
  <div class="controls text-right">
            <div data-toggle="buttons-checkbox" class="btn-group">
              <button  class="btn btn-default" title='Export PDF' type="button"><a target="_blank" href="/user_access_export"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></button>
              <button class="btn btn-default" title='Export Excel' type="button"><a  href="/user_access_export_excel"><i class="fa fa-file-excel-o" aria-hidden="true"></i></a></button>
              <button class="btn btn-default" title='Preview' ttype="button"><a target="_blank" href="/user_access_export"><i class="fa fa-street-view" aria-hidden="true"></i></a></button>
	...
	<ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-bars" aria-hidden="true"></i>User List</a></li>
        @permission('INSERT')
        <li><a data-toggle="tab" href="#menu1"><i class="fa fa-plus-circle" aria-hidden="true"></i> User Access </a></li>
        @endpermission
    </ul>
  	...
  	<div class="tab-content"> <!-- Transport List Report  -->
        ...
        <div id="home" class="tab-pane fade in active">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span><h5>Show</h5></div>
              		...
              		<table class="table table-bordered data-table">
						...
						<tbody>
		                    ...
		                    <tr class="gradeX">
		                    	...
		                    	@php $user_name=DB::table('users')->where('id',$user_access_list->user_id)->first(); @endphp
		                    	@php $role_name=DB::table('roles')->where('id',$user_access_list->role_id)->first(); @endphp
		...
		<div id="menu1" class="tab-pane fade">
			<div class="widget-box">
	        	<div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span><h5>User Access</h5></div>
		        <div class="widget-content nopadding">
