    ...
    <div class="container">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                {{--              ------------------------------}}
                <form action="/admit_student" method="post" enctype="multipart/form-data" class="admin_student form-horizontal" id="basic_validate" novalidate='novalidate'>
                            ...
                            <div class="controls">
                                <table class="table address p_address_tables">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control village_name" id="required" placeholder="Village/House No." title="Village/House No." name="village_name" type="text" value="">

                                        </td>
                                        <td>
                                            <input class="form-control post_office" id="required" placeholder="Post Office Code No." title="Post Office Code No." name="village_name" type="text" value="">
                            ...
                            <div class="controls">
                                <table class="table address present_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="table_text present_village_name" id="required" placeholder="Village/House No." title="Village/House No." name="present_village_name" type="text" value="">

                                        </td>
                                        <td>
                                            <input class="table_text present_post_office" id="required" placeholder="Post Office Code No." title="Post Office Code No." name="present_post_office" type="text" value="">
                                        </td>
                                    </tr>
                                ...
                                <table class="table education_history">
                                    ...
                                    <tr class="educational_tr">
                                        ...
                                        <td class="others_university" hidden='hidden'>
                                            <input type="text" value="university_name[]" class="form-control university_name" id="required" placeholder="University Name" tittle="University Name" style="width: 100%" />
                                        </td>
                                        <td>
...
--}}
                                        ...
                                        <td>
                                            <input type="text" name="reg_no[]" class="form-control" id="required" placeholder="Reg No" tittle="Reg No" style="width: 100%" />
                                        </td>
                                        <td>
                                            <input type="text" name="roll_no[]" class="form-control" id="required" placeholder="Roll No" tittle="roll_no" style="width: 100%" />
                                        <td>
                                            <input type="text" name="gpa[]" class="form-control table_text" id="required" placeholder="Division/GPA" tittle="Division/GPA" style="width: 100%" />
                                        </td>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data[0]) {
                            ...
                            $('.department').append('<option selected>----No Data Found----</option>');
                        }
                    }
                });
            }); 
