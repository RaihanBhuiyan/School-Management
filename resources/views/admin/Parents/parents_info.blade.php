...
@if (Session::has('wrong'))
    <div class="alert alert-danger alert-dismissible fade in">
                <a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong><i class="fa fa-commenting-o" aria-hidden="true"></i> &nbsp; Error!</strong> {{ Session::get('wrong') }}
    </div>
...
<div class="container">
  ...
  <!-- Tab Heading  -->
  <p title="Transport Details">{{Session::get('school.system_name')}}( {{Session::get('school.school_eiin')}} )  Parent's Info Add</p>
  <!-- Transport Details -->
     ...
     <div class="panel panel-default" >
      <div class="panel-body text-left">
         <ul class='dropdown_test'>
            ...
            <li><a href='/parentreport'><i class="fa fa-list-alt" aria-hidden="true"></i> &nbsp;Parent's List</a></li>
