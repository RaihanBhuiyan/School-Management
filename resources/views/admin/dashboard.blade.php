...
<!--Chart-box-->
          @php
           $student_data=DB::table('students')->get()->count();
           $teacher_data=DB::table('teacher')->get()->count();
           $parents_data=DB::table('parents_info')->get()->count();
           $attendance_data=DB::table('daily_attendance')->get()->count();
           $transport=DB::table('manage_transport')->get()->count();
           $Article=DB::table('article_info')->get()->count();
           $general=DB::table('general_settings')->first();
           $general_data=$general->default_session;
           $Hostel=DB::table('manage_dormitory')->get()->count();
                ...
                <script type="text/javascript">
                        ...
                        function drawVisualization() {
                          ...
                          var data = google.visualization.arrayToDataTable([
                           ...
                           ['<?=$general_data?>',<?=$student_data?>,<?=$teacher_data?>,<?=$parents_data?>,<?=$attendance_data?>,<?=$transport?>,<?=$Article?>,<?=$Hostel?>],
...
<!--End-Chart-box-->
        ...
        <div class="widget-box">
          ...
          <div class="widget-content tab-content">
            <div id="tab1" class="tab-pane active">
              <p>Codebool I-School Management System is the most complete and versatile school management system on envato market. Codebool provides the most advanced backend erp. Whatever platform you want to use, Codebool has got your back.</p>
              <img src="{{asset('img/codebool_ischool_2.jpg')}}" alt="demo-image" style="width: 100%;" /></div>
            <div id="tab2" class="tab-pane"> <img src="{{asset('img/codebool_ischool.jpg')}}" style="width: 100%;height: 288px;" alt="demo-image"/>
              <p>School Management System is a is a complete school management software designed to automate a school's diverse operations from classes, exams to school events calendar.</p>
            </div>
            <div id="tab3" class="tab-pane">
              ...
              <img src="{{asset('img/codebool1.jpg')}}" alt="demo-image" style="width: 100%; height: 287px;"/></div>
          </div>
        </div>
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-ok"></i></span>
            <h5>Dormitory Overview</h5>
             ...
             @php
            $manage_dormitory=DB::table('manage_dormitory')->get()->count();
            $assign_dormitory=DB::table('assign_dormitory')->get()->count();
          @endphp
           <div class="widget-content">
           <div class="widget-content">
                <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      <div class="span6" style="margin-left: -2%;">
        ...
        <div class="widget-box">
          ...
          @php
            $paid=DB::table('invoice')->where('cash_status','Paid')->get()->count();
            $unpaid=DB::table('invoice')->where('cash_status','Unpaid')->get()->count();
 ...
 <div class="span6" style="margin-left: -2%;">
        <div class="widget-box">
          ...
          @php
           $total_book=DB::table('article_info')->get()->count();
           $issued=DB::table('article_issue')->get()->count();
           $returned=DB::table('article_recive')->get()->count();
           $membership=DB::table('membership')->get()->count();
          @endphp
