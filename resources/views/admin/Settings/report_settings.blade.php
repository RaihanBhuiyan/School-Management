  ...
  $(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append("<div class='test'><input type='text' class='b_s_name' placeholder='Name' name='name[]'><input type='text' class='b_s_reg' placeholder='Designation' name='designation[]'>&nbsp;<a href='#' style='margin-bottom: 2px;margin-top: 3px;'  class='remove_field btn btn-danger'><i class='fa fa-trash' aria-hidden='true'></i></a></div>"); //add input box
        }
        else
        {
